...
import com.chatapp1.WiFiDirectServicesList.DeviceClickListener;
import com.chatapp1.WiFiDirectServicesList.WiFiDevicesAdapter;
import com.chatapp1.WifiChatFragment.MessageTarget;
...
public class WiFiServiceDiscoveryActivity extends Activity implements
  ...
  public void onConnectionInfoAvailable(WifiP2pInfo p2pInfo) {
    ...
    if (p2pInfo.isGroupOwner) {
      ...
      handler = new ClientSocketHandler(((MessageTarget) this).getHandler(),
