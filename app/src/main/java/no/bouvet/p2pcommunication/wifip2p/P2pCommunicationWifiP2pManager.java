...
public class P2pCommunicationWifiP2pManager {
  ...
  public void startPeerDiscovery(DiscoveryStateListener discoveryStateListener) {
    wifiP2pManager.discoverPeers(wifiP2pChannel,
        new WifiP2pStartPeerDiscoveryActionListener(context, discoveryStateListener));
  }

  public void stopPeerDiscovery(DiscoveryStateListener discoveryStateListener) {
    wifiP2pManager.stopPeerDiscovery(wifiP2pChannel,
        new WifiP2pStopPeerDiscoveryActionListener(context, discoveryStateListener));
  }
  ...
  public void connect(WifiP2pDevice wifiP2pDevice,
      InvitationToConnectListener invitationToConnectListener) {
    wifiP2pManager.connect(wifiP2pChannel, createWifiP2pConfig(wifiP2pDevice),
        new WifiP2pConnectActionListener(context, invitationToConnectListener));
  }
