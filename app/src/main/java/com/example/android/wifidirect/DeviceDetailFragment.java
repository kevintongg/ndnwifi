 ...
 * i.e. setting up network connection and transferring stringData.
 */
...
//			server_running = true;
	...
	/**
	 * Updates the UI with device stringData
	 * 
	...
	/**
	 * A simple server socket that accepts connection and writes some stringData on
	 * the stream.
	 */
